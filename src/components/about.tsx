    ...
    return (
        <Container className={styles.pageContainer}>
            <Grid container spacing={5} direction="column">
                <Grid item>
                    <Typography variant="h3" component="h1" gutterBottom>About CoderLab</Typography>
                    <Typography>
                ...
                <Grid item>
                    <Typography variant="h5" component="h3" gutterBottom>Our approach</Typography>
                    <Typography>
                ...
                <Grid item>
                    <Typography variant="h5" component="h3" gutterBottom>Our staff</Typography>
                    <Staff />
                </Grid>
            </Grid>
